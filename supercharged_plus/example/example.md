...
main() {
  ...
  // Sort order helpers
  var numbers1 = [1, 3, 2, 4]..sortAsc(); // Results in [1, 2, 3, 4]
  var numbers2 = [1, 3, 2, 4]..sort((a, b) => sortAsc(a, b)); // Results in [1, 2, 3, 4]

  var numbers3 = [1, 3, 2, 4]..sortDesc(); // Results in [4, 3, 2, 1]
  var numbers4 = [1, 3, 2, 4]..sort((a, b) => sortDesc(a, b)); // Results in [4, 3, 2, 1]
}
